      ...
      <Dialog open={!!selectedTemplate} onOpenChange={(open) => !open && setSelectedTemplate(null)}>
        <DialogContent className="sm:max-w-[425px] rounded-xl border-slate-200 bg-white p-6 shadow-sm">
          <DialogHeader className="mb-4">
            <DialogTitle className="text-xl font-semibold text-slate-900">Gunakan Template</DialogTitle>
          ...
          <div className="py-4">
            {workspaces.length > 0 ? (
              ...
              >
                ...
                <SelectContent alignItemWithTrigger={false} className="w-[var(--anchor-width)] rounded-lg border-slate-200 bg-white shadow-sm z-50">
