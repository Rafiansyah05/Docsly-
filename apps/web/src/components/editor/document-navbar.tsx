...
import { ChevronLeft, Table as TableIcon, Image as ImageIcon, ListOrdered, BookOpen, History, Download, Loader2, Settings2, Printer } from 'lucide-react';
    ...
    <div className="flex items-center justify-between px-4 py-1.5 border-b border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-950 min-h-[3rem] flex-wrap gap-y-2">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <PrintDialog editor={editor} layout={layout}>
            <Button
              disabled={!editor}
              variant="outline"
              size="sm"
              className="h-7 px-2 bg-zinc-50 dark:bg-zinc-900 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 border-zinc-200 dark:border-zinc-800 transition-all rounded-lg"
              title="Cetak Dokumen"
            >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                variant="outline"
                size="sm"
                className="h-7 px-2 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-zinc-200 border-zinc-900 dark:border-zinc-100 transition-all rounded-lg"
