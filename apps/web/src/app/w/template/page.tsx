...
export default async function TemplatePage() {
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto px-8 py-8 md:py-10 space-y-10">
      <div className="flex flex-col border-b border-slate-200 pb-6 space-y-1">
        <h1 className="text-[32px] font-semibold tracking-tight text-slate-900 leading-none">Template Dokumen</h1>
        <p className="text-[14px] text-slate-500 mt-2 max-w-2xl">
