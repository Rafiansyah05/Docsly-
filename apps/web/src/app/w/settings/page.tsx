...
export default async function SettingsPage() {
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto px-8 py-8 md:py-10 space-y-10">
      <div className="flex flex-col border-b border-slate-200 dark:border-slate-800 pb-6 space-y-1">
        <h1 className="text-[32px] font-semibold tracking-tight text-slate-900 dark:text-white leading-none">Pengaturan</h1>
